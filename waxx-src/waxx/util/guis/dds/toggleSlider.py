...
from PyQt6.QtWidgets import QApplication, QLabel, QWidget, QVBoxLayout, QHBoxLayout, QGridLayout, QLineEdit, QPushButton, QMainWindow
...
class AnimatedToggle(QCheckBox):
    ...
    def __init__(self,
        ...
        checked_color="#006600",
        handle_color=Qt.GlobalColor.white,
        pulse_unchecked_color="#44999999",
        pulse_checked_color="#009900"
        ):
